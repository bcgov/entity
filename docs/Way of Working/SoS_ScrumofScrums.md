...
- New Business
    - Ux, SRE, OCM tasks on the dev board
    - breakdown epic 9795 into small tasks/tickets

- Meeting Notes
    - We'll as much as possible to keep Ux, SRE, OCM tasks in the New Issues pipeline of the dev boards
    - We'll continue to look for ways that we can drive efficiciencies in our dev workflow
---
Oct 27
---
- Action Items
...
- Meeting Notes
    - Creating sprints
        - Assets/Entities Team to begin next sprint
    - Ux Velocity / Adding to milestones
        - Continue to include Ux tickets in team milestone
    - Fibonacci
        - one method is to create a frame of reference such as a story/task that will take 1 day to develop and implement, estimate it at 1 point and then estimate all other stories/tasks relative to the reference story
---
Oct 20
---
- Action Items
    - When an item is moved to the Ux Assurance / Verification
        - Action: Create  manual notification to UX rocket chat channel
    - Improve Quality
        - Action: publish code coverage stats - create a ticket for Patrick
...
- New Business
    - Comments about the new workspaces (tracking Ux tickets on the design board)
    - Naming sprints using the PI.sprint# convention
    - Where to record sprint goals - (milestones dissapearing at the end of 2021)
---
Oct 13
---
...
- New Business
    - Remember to move Ux tickets on the Design Team board
    - Pick a few ideas from the maturity assessment brainstorm to implement
    - Ideas from Jingua for common practices
    - Date for moving Entities + Relationships to their team boards
...
---
- Standing Agenda: 
    - Tech Review agenda and participation from the devs
...
- New Business
    - Ceremonies
        - Which ceremonies should be re-occurring
        - How do we keep them tight
