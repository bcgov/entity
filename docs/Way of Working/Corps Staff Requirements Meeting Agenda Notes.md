...
- [using VON to select your "incorporator" Corproation or Firm from a list of companies](https://app.zenhub.com/workspaces/entity-5bf2f2164b5806bc2bf60531/issues/bcgov/entity/6877)
  ...
  -  What happens if no enity comes up? Will we just have them type it in? Do we care to track if they got the name from the VON list, or if they typed it in themselves?
- Historical COLIN outputs message ([4716](https://app.zenhub.com/workspaces/entity-5bf2f2164b5806bc2bf60531/issues/bcgov/entity/4716))
...
May 25th 2021
----
[Meeting Notes](https://citz.sp.gov.bc.ca/sites/SBC/REG/Projects/MVSM/_layouts/15/DocIdRedir.aspx?ID=S52QENDTEJAE-1724982671-3991)
...
- For coop incorporation
-  1)	Do we need a category “Certain Producer Association”?  This wasn’t raised in any requirements meeting that I recall. - No
-  2)	How would you like to see these coop types labelled in the drop down list and also on the coop summary when it is built?  Would the following work?
      - a.	Cooperative without a special purpose - don't need to know this
      - b.	Special purpose – housing cooperative - don't need to know this
      - c.	Special purpose – community service cooperative
      - d.	Special purpose – certain producer association - don't need this
      - Answer: maybe only have a checkbox instead for community service cooperative (this will need to display on the search eventually)
      - This could reduce corrections.
   3) Need helptext to NOT upload occupancy agreements if you are a housing cooperative
   4) May need helptext to explain what a community service cooperative is.  Text from bcca.coop - Community service co-ops are a designation recognized under the Cooperative Association Act. Under BC law, community service co-ops have a similar status to that of non-profit societies.  Community service co-ops require the inclusion of non-alterable clauses in their rules to ensure they operate on a non-profit basis, and their purpose is charitable, or to provide health, social, educational or other community services - Amber will tweak the wording
- 5) Review incorporation guide - see Aug 6th email.
...
IA - nice to see number here.  Is this because we don't have FED?
...
- https://app.zenhub.com/workspaces/entity-5bf2f2164b5806bc2bf60531/issues/bcgov/entity/9007 Affidavits
  ...
  - For the note "The affidavit is to be sworn before a Commissioner for Taking Affidavits for British columbia or a Notary Public with a seal affixed.
     -see comments in invision
      - 
- Special resolution date
- - is the resolution sufficient or do we need to record the resolution date for coops?  Don't need the date for coops.  it's on the resolution being uploaded.
...
- https://app.zenhub.com/workspaces/entity-5bf2f2164b5806bc2bf60531/issues/bcgov/entity/8274 Messaging after the filing
  - Do we need to send info to MRAS - pretty sure not - ask Darci
...
- - no BN messaging for CP's; need BN messasing for Corps
...
- Discuss #99
- Discuss the next ticket, co-op missing number, and how we can correct their rules
