module.exports = {
    ...
    'Signin': function (browser) {
      browser
          ...
          .setValue('/html/body/div/div/div[2]/div/div/article/div/div/div/form/div[2]/div/div[1]/div/input', browser.globals.CP0001252.identifier)
          .waitForElementVisible('/html/body/div/div/div[2]/div/div/article/div/div/div/form/div[3]/div/div[1]/div[1]/input')
          .setValue('/html/body/div/div/div[2]/div/div/article/div/div/div/form/div[3]/div/div[1]/div[1]/input', browser.globals.CP0001252.passcode)
          .useCss()
    ...
    'Confirm initial state of COD filing': function (browser) {
      ...
      'Appoint New Director': function (browser) {
        ...
        CodPage.validateDirectorByNumber(browser.globals.CP0001252.director3,3)
      },
     ...
     'Assert the directors are present': function (browser) {
      ...
      'Delete draft': function (browser) {
        ...
        dashboard.waitForElementVisible('@fileNowButton');   //will run in e2e scripts
      },
