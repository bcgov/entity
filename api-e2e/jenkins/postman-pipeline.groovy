...
podTemplate(label: py3nodejs_label, name: py3nodejs_label, serviceAccount: 'jenkins', cloud: 'openshift', containers: [
    containerTemplate(
        ...
        envVars: [
            ...
            secretEnvVar(key: 'CODTRAEVENTID',secretName: "postman-e2e-secret",secretKey: 'codExtraEventId'),
                    ...
                    stage("Running ${name} pm tests") {
                        try {
                           ...
                           // def url_name = "url"
                            ...
                            --global-var ${url_name}=${url} --global-var auth_url=${AUTHURL} --global-var realm=${REALM} \
                            ...
                            --global-var clientId=${CLIENTID} --global-var clientSecret=${CLIENTSECRET} \
